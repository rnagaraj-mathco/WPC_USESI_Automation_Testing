...
//    By CPA_GeographicalMap = By.xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[3]/div[3]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/*[name()='svg'][1]/*[name()='g'][8]/*[name()='g'][1]/*[name()='g'][1]/*[name()='rect'][1]");
    ...
    By CPA_Filters_Regions = By.xpath("/html/body/div[1]/div/div/div/div[2]/div[1]/div[2]/div[3]/div[1]/div/div[1]/div/div/div/div[1]/div[1]/div/div[1]/div");
    //Filters- Regions - 02 options
    By CPA_Filters_Regions_02 = By.xpath("/html/body/div[1]/div/div/div/div[2]/div[1]/div[2]/div[3]/div[1]/div/div[1]/div/div/div/div[2]/div[1]/div/fieldset/div/label[3]/span[1]/span[1]/input");
    //Filters- Regions - 02 options
    By CPA_Filters_Regions_12 = By.xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[3]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/fieldset[1]/div[1]/label[8]");
    //Filters- Order Channel (Branch, CDC)
    By CPA_Filters_OrderChannel = By.xpath("/html/body/div[1]/div/div/div/div[2]/div[1]/div[2]/div[3]/div[1]/div/div[1]/div/div/div/div/div[1]/div/div[8]/div");
    //Filters - Order Channel - All option as it un-checks all other options
    By CPA_Filters_OrderChannel_Branch_All = By.xpath("/html/body/div[1]/div/div/div/div[2]/div[1]/div[2]/div[3]/div[1]/div/div[1]/div/div/div/div[2]/div[1]/div/fieldset/div/label[1]/span[1]/span[1]/input");
    //Fitler- Order Channel - Branch
    By CPA_Filters_OrderChannel_Branch = By.xpath("/html/body/div[1]/div/div/div/div[2]/div[1]/div[2]/div[3]/div[1]/div/div[1]/div/div/div/div[2]/div[1]/div/fieldset/div/label[2]/span[1]/span[1]/input");
    //Select Metric - Dropdown
    By CPA_SelectMetric_Dropdown = By.xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[3]/div[3]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/span[1]");
...
//    By CPA_SelectBranch_Map = By.xpath("");
    ...
    //Navigating to the Branch/Customer screen
  	public void navigateTo() throws IOException, InterruptedException {
          ...
          File screenshotPath = new File("src/test/resources/screenshots/CustomerPeerAnalysis/Selections/BranchCustomerSelections/BranchCustomerSelectionScreen.png");
  	...
  	public void FiltersTo() throws IOException, InterruptedException {
        ...
        //waitForElement(CPA_Filters_Regions_02);
     	...
     	((JavascriptExecutor) driver).executeScript("arguments[0].scrollTop = arguments[0].scrollHeight", FiltersOrderChannelCustomerPeerSelections);
        ...
        TakesScreenshot screenshot = (TakesScreenshot) driver;
        File sourcefile = screenshot.getScreenshotAs(OutputType.FILE);
        File screenshotPath = new File("src/test/resources/screenshots/CustomerPeerAnalysis/Selections/BranchCustomerSelections/Filters_Options.png");
        FileHandler.copy(sourcefile, screenshotPath);	
  	...
  	public void SelectMetric() throws IOException, InterruptedException {
  		...
  		new Actions(driver).moveToElement(SelectMetric_Dropdown_Options).click().perform(); //This line is added for the hovering effect
  		System.out.println("--- Selected the Return (Handling) Metric from the options");
  		Thread.sleep(5000);	
  	    // Screenshot of the Select Metric options
        TakesScreenshot screenshot = (TakesScreenshot) driver;
        File sourcefile = screenshot.getScreenshotAs(OutputType.FILE);
        File screenshotPath = new File("src/test/resources/screenshots/CustomerPeerAnalysis/Selections/BranchCustomerSelections/Metric_Options.png");
        FileHandler.copy(sourcefile, screenshotPath);
  	}
...
//  		}
  	...
  	public void SelectBranchDropdown() throws IOException, InterruptedException {
  		...
  		((JavascriptExecutor) driver).executeScript("arguments[0].scrollTop = arguments[0].scrollHeight", SelectBranch_Dropdown_Options_ENRG);
...
//  		Thread.sleep(3000);
        ...
        TakesScreenshot screenshot = (TakesScreenshot) driver;
        File sourcefile = screenshot.getScreenshotAs(OutputType.FILE);
        File screenshotPath = new File("src/test/resources/screenshots/CustomerPeerAnalysis/Selections/BranchCustomerSelections/Branch_Dropdown_Options.png");
        FileHandler.copy(sourcefile, screenshotPath);
  	}
