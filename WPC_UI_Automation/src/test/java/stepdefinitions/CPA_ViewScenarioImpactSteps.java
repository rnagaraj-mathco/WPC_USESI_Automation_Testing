...
//	}
	...
	public void the_user_should_be_able_to_click_on_the_back_button_which_then_redirects_to_the_create_scenario_screen()
		...
		cpa_viewScenarioImpact.backBtn();
	}

	@Then("the user should be able to click on the Filters button and perform actions such as Apply, Reset and Cancel based on requirements")
	public void the_user_should_be_able_to_click_on_the_filters_button_and_perform_actions_such_as_apply_reset_and_cancel_based_on_requirements()
			throws IOException, InterruptedException {
		cpa_viewScenarioImpact.filtersTo();
	}

	@When("the user clicks on the After button,the chart is displayed should be displayed with simulated values")
	public void the_user_clicks_on_the_after_button_the_chart_is_displayed_should_be_displayed_with_simulated_values()
			throws IOException, InterruptedException {
		cpa_viewScenarioImpact.afterBtn();
	}
	...
	public void the_user_clicks_on_the_comparison_button_which_should_display_a_table_showing_the_differences_between_the_default_and_simulated_scenario_values()
			throws IOException, InterruptedException {
		cpa_viewScenarioImpact.comparisonBtn();
	}
	...
	public void the_user_should_be_able_to_search_for_a_keyword_in_the_comparison_table()
			throws IOException, InterruptedException {
		cpa_viewScenarioImpact.searchKeywordComparison();
	}
	...
	public void the_user_should_be_able_to_click_the_download_icon_in_the_comparison_table_header_to_download_the_table_records_as_an_excel_file()
			throws IOException, InterruptedException {
		cpa_viewScenarioImpact.downloadIconComparison();
	}
	...
	public void the_user_should_be_able_to_click_on_the_reset_button_which_redirects_the_the_user_to_the_branch_customer_selection_screen()
			throws IOException, InterruptedException {
		cpa_viewScenarioImpact.resetBtn();
	}
