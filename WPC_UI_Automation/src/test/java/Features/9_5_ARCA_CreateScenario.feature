...
#--->Create Scenario - Simulation using Enforce Per Return Surcharge
 Scenario: Verify that the user is able to create a scenario using the Enforce Per Return Surcharge simulation
	...
	When the user clicks on the Customer Details button, a popup should appear titled Select Customer and Products Combination containing Selected Target Customer for Simulation and Selected Product for Root Cause Analysis table
 	...
 	Then the user clicks on the Reset Simulation button of the Pre-Programmed Scenario widget, the simulator should reset to its previous state 	
  ...
  Then the user should be able to select the Enforce Per Order Return Surcharge simulation and enter the %Sales value, click on the Create Scenario button, then the scenario should be created
  #Then the user clicks on the Reset Simulation button of the Pre-Programmed Scenario widget, which resets the simulator to its previous state
  #---- This Error msg has to implemented but due to dev issue of error msg in estimated impact widget for now reset simulation of Pre- Programmed scenario widget
  Then the user clicks on the Reset Simulation button of the Estimated Impact widget, the simulator should reset to its previous state
  ...
  Then the user should be able to select the Enfore Per Order Return Surcharge simulation and enter the Flat$ value, click on the Create Scenario button, then the scenario should be created
 ...
 #	Then the user selects and toggles the Eliminate System Pricing Overrides Surcharge
 #	When the user clicks on the Create Scenario button then,a scenario should be created with before and after comparison in the Estimated Impact widget
 #---Download the chart
  #Then the user clicks on the download icon of the before simulation chart, which should download the chart as an image  
 #	Then the user clicks on the download icon of the after simulation, which should download the chart as an image
 #	#---Save Scenario button
 ...
 #	#--- Reset Simulation - Estimated Impact - To enable the next scenario
 #	When the user clicks on the Reset Simulation button of the Estimated Impact widget, the simulator should reset to its previous state
 ...
 #	Then the user selects the Move To A New Customer Price Class and selects a price class from the dropdown
 #	When the user clicks on the Create Scenario button then,a scenario should be created with before and after comparison in the Estimated Impact widget
 #---Download the chart
  #Then the user clicks on the download icon of the before simulation chart, which should download the chart as an image  
 #	Then the user clicks on the download icon of the after simulation, which should download the chart as an image
