...
Feature: Land on the Peer Selection screen where the user should be able to select a customer from the set of customers chosen on the 
  ...
  #Peer Selection 01 Target Customer Selection - Customer Selection by clicking on the records of the table
  Scenario: Verify that the user is able to select a customer from the Select Target Customer for Peer Matching table
    ...
    And the user should be able to click on the Download icon present in the table header, which downloads the table records as an Excel file
 ...
 #Peer Selection 01 Target Customer Selection - Customer Selection by Searching and Selecting the the record
  Scenario: Verify that the user is able to select a customer by searching the record from the Select Target Customer for Peer Matching table
    ...
    #And the user should be able to zoom in and out of the table using the + and - icons
    #And the user should be able to click on the column filter icon to select which columns should be displayed in the Select Target Customer for Peer Matching table
    And the user should be able to search for a customer record and select it from the table and click on the Select Customer button, which redirects to the Peers Selection screen only if one record is selected
    When user clicks on the Select Customer button without selecting any records, an error message should be displayed
    And the user should be able to click the Back button, which then redirects to the Branch/Customer Selection page
    #Then user should be able to interact with the Rows per page dropdown of the Select Target Customer for Peer Matching table and select a value, which updates the visible records
 ...
 #Peer Selection 02 Comparative Peer Group Selection -- SPMC - Peer Dropdown - Table - Buttons
    ...
    Then the user is on the Peer Selection page, where the user should be able to click on the Set Peer Matching Crieteria button to enter threshold values and select a similarity model
    ...
    Then the user should be able to select/deselect the peers by clicking on the checkbox of each peer record
    And the user should be able to search for the peers records and then do either select/deselect the peers
 ...
 #Peer Selection 02 Comparative Peer Group Selection - SPMC - Peer Dropdown - Buttons (In table only search, download,column filters happens)
	Scenario: Verify that the user is able to select the peers by clicking on the Select Peer Matching Crieteria button and 
    ...
    And the user should be able to select a customer record from the table and click the Select Customer button, which redirects to the Peers Selection screen only if one record is selected
    #SPMC - Peer Dropdown - Table - Buttons
    Then the user is on the Peer Selection page, where the user should be able to click on the Set Peer Matching Crieteria button, where the user would be able to give the Threshold value and select the similarity model
    Then the user should be able to click on the Select Peers Dropdown and select the peers count 
    And the user should be able to search for a keyword in the Select Comparative Peer Group table 
    And the user should be able to click on the download icon present in the Select Comparative Peer Group table header, which downloads the table records as an Excel file
    #And the user should be able to zoom in and out of the Select Comparative Peer Group table using the + and - icons
    #And the user should be able to click on the column filter icon to select which columns should be displayed in the Select Comparative Peer Group table
 ...
 #Peer Selection 02 Comparative Peer Group Selection - SPMC(View) - Peer Dropdown - Table - Buttons
    ...
    Then the user is on the Peer Selection page, where the user should be able to click on the Set Peer Matching Crieteria button and view the threshold value and the model selected
    Then the user should be able to click on the Select Peers Dropdown and select the peers count 
    And the user should be able to search for a keyword in the Select Comparative Peer Group table 
    And the user should be able to click on the download icon present in the Select Comparative Peer Group table header, which downloads the table records as an Excel file
    #And the user should be able to zoom in and out of the Select Comparative Peer Group table using the + and - icons
