...
public class CPA_PeerSelectionPage {
	...
	// SearchField
	By CPA_PS1_PS1_SearchKeywordSelectTargetCustomer = By.xpath(
	...
	public void searchForKeyword_STC() throws IOException, InterruptedException {
		WebElement PS1_SearchKeywordSelectTargetCustomer = waitForElement(
				CPA_PS1_PS1_SearchKeywordSelectTargetCustomer);
